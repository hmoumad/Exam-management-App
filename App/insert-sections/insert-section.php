...
<head>
	...
	<style>
		...
		.section-container>.content>div>select{
			height: 30px;
		    border-radius: 4px;
		    font-size: 1rem;
		    text-align: center;
	...
	<div class="section-container">
		<div class="content">
			...
			<div>
				...
				<select id="s2" class="form-select" aria-label="Default select example" name="code_filiere"></select>
			</div>

			<br>
			<div class="button">
				<button name="section-number" class="btn btn-primary" onclick="nombreEtudiant()">affiche</button>
			</div>
